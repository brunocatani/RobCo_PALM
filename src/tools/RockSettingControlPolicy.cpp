...
namespace rock_configurator::setting_control
{
    namespace
    {
        ...
        constexpr auto kNumericRanges = std::to_array<NumericRange>({
            ...
            { "fGrabPinchThinRodMaxCrossSectionGameUnits", 0.1, 40.0 },
            { "fGrabPinchThinRodMaxLengthGameUnits", 1.0, 120.0 },
            ...
            { "fSelectionBeamAlpha", 0.05, 1.0 },
            { "fSelectionBeamCurveLiftGameUnits", 0.0, 80.0 },
            { "fSelectionBeamSegmentSizeGameUnits", 0.2, 6.0 },
