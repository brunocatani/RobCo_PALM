...
int WINAPI wWinMain(HINSTANCE instance,HINSTANCE,PWSTR,int show){
 ...
 const auto hwnd=CreateWindowW(wc.lpszClassName,L"ROCK Wheel Menu — Interactive Preview",WS_OVERLAPPEDWINDOW,CW_USEDEFAULT,CW_USEDEFAULT,1040,1060,nullptr,nullptr,instance,nullptr);
 if(!hwnd)return 1;
 ...
 auto model=wheel::demoInventory();wheel::View view;
